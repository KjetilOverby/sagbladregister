...
export const bandhistorikkRouter = createTRPCRouter({
  columns: protectedProcedure
    .input(
      z.object({
        ...
        sagtid: z.boolean(),
        feilkode: z.boolean(),
        temperatur: z.boolean(),
        sideklaring: z.boolean(),
        ampere: z.boolean(),
        stokkAnt: z.boolean(),
        anmSag: z.boolean(),
        creator: z.boolean(),
        ...
        bladType: z.boolean(),
        datoSrv: z.boolean(),
        activePost: z.boolean(),
        bladeRelationId: z.boolean(),
        alt: z.boolean(),
        creator2: z.boolean(),
        creatorImg2: z.boolean(),
        creator3: z.boolean(),
        creatorImg3: z.boolean(),
        date: z.string(),
        date2: z.string(),
        antRep: z.boolean(),
        antTannslipp: z.boolean(),
        orderBy: z
          .object({
            field: z.string(),
  ...
  create: protectedProcedure
    .input(
      z.object({
        ...
        bladType: z.string(),
        activePost: z.boolean(),
        bladeRelationId: z.string(),
        alt: z.string(),
        creator: z.string(),
        creator2: z.string(),
        creatorImg2: z.string(),
        creator3: z.string(),
        creatorImg3: z.string(),
        antRep: z.number(),
        antTannslipp: z.number(),
        stokkAnt: z.number(),
      }),
    )
    .mutation(({ ctx, input }) => {
  ...
  getFlaws: protectedProcedure.query(({ ctx }) => {
